  ...
  <div class="content-wrapper">
    <div class="container-fluid">      
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">PROFIL PONDOK PESANTREN</li>
      </ol>
      <div class="row">        
        <div class="col-lg-8">        
        ...
        <div class="col-lg-4">
          <div class="card mb-1 bg-success text-light">
            <div class="card-header">
              <i class="fa fa-camera"></i> Pondok Pesantren Al Mubarok</div>
            <a href="#">
